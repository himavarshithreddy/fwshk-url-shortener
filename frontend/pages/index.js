  ...
  return (
    <div className="app-container">
      <Head>
        ...
        <meta property="og:title" content="brnk — Minimalist URL Shortener & QR Generator" />
        <meta property="og:description" content="Put your long links on a diet. Free URL shortener, custom links, expiration controls, and real-time click tracking." />
        <meta property="og:site_name" content="brnk" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:image" content="https://brnk.in/logo512.png" />
        <meta property="og:image:width" content="512" />
        <meta property="og:image:height" content="512" />
        <meta property="og:image:alt" content="brnk logo - orange and white abstract shape" />
        
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:url" content="https://brnk.in" />
        <meta name="twitter:title" content="brnk — Minimalist URL Shortener & QR Generator" />
        <meta name="twitter:description" content="Put your long links on a diet. Free URL shortener, custom links, expiration controls, and real-time click tracking." />
        <meta name="twitter:image" content="https://brnk.in/logo512.png" />
        <meta name="twitter:image:alt" content="brnk logo - orange and white abstract shape" />
      ...
      <section className="seo-content" aria-label="About brnk URL Shortener">
        ...
        <ol className="seo-steps">
          ...
          <li><strong>Track</strong> — Visit the <Link href="/track">tracking page</Link> to view click analytics for your links.</li>
        </ol>

        <h2 className="seo-content-heading">Frequently Asked Questions</h2>
        <div className="seo-faq">
          <div className="faq-item" style={{ marginBottom: '20px' }}>
            <h3 style={{ fontSize: '1.2rem', marginBottom: '8px' }}>Is brnk.in really free?</h3>
            <p>Yes, our URL shortening and QR code generation services are 100% free to use. We are supported by minimal advertisements.</p>
          </div>
          <div className="faq-item" style={{ marginBottom: '20px' }}>
            <h3 style={{ fontSize: '1.2rem', marginBottom: '8px' }}>Do I need an account to track clicks?</h3>
            <p>No account is required! Simply go to our <Link href="/track" style={{ color: '#ff6600' }}>Track</Link> page and enter your short URL code to view real-time click analytics.</p>
          </div>
          <div className="faq-item" style={{ marginBottom: '20px' }}>
            <h3 style={{ fontSize: '1.2rem', marginBottom: '8px' }}>How long do the shortened links last?</h3>
            <p>By default, links last forever. However, you can use the advanced settings when creating a link to set an automatic expiration date (e.g., 1 hour, 1 day, or 1 week).</p>
          </div>
          <div className="faq-item" style={{ marginBottom: '20px' }}>
            <h3 style={{ fontSize: '1.2rem', marginBottom: '8px' }}>Can I customize the short URL?</h3>
            <p>Yes, you can enter a custom slug in the "Custom Link (optional)" field to create branded links like brnk.in/your-brand.</p>
          </div>
          <div className="faq-item" style={{ marginBottom: '20px' }}>
            <h3 style={{ fontSize: '1.2rem', marginBottom: '8px' }}>What is the difference between 301, 302, and 308 redirects?</h3>
            <p>A 302 redirect (default) is temporary, meaning search engines won't pass SEO authority to the destination. A 301 or 308 redirect is permanent and passes full SEO authority. Advanced users can select their preferred redirect type when shortening a link.</p>
          </div>
        </div>
